...
model = dict(
    ...
    train_cfg = dict(
        ...
        val_batch_size = 512,
        model_path = 'checkpoints/LSTM/argo',
        val_path = 'checkpoints/LSTM/argo/LSTM_rollout30.pth.tar',
    ),
    test_cfg = dict(
        test_batch_size = 512,
        joblib_batch_size = 100,
        model_path = 'checkpoints/LSTM/argo/LSTM_rollout30.pth.tar',
        traj_save_path = '../saved_trajectories/lstm/rollout30_traj_test.pkl',
    ),
    val_cfg=dict(
        test_batch_size = 512,
        joblib_batch_size = 100,
        model_path = 'checkpoints/LSTM/argo/LSTM_rollout30.pth.tar',
        traj_save_path = '../saved_trajectories/lstm/rollout30_traj_val.pkl',
