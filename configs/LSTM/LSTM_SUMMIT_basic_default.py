...
model = dict(
    ...
    train_cfg = dict(
        ...
        val_batch_size = 512,
        model_path = 'checkpoints/LSTM/summit',
        val_path = 'checkpoints/LSTM/summit/LSTM_rollout30.pth.tar',
    ),
    test_cfg = dict(
        test_batch_size = 512,
        joblib_batch_size = 100,
        model_path = 'checkpoints/LSTM/summit/LSTM_rollout30.pth.tar',
...
### -------------- Evaluation ----------------- ###
work_dir = 'work_dirs/LstmBasic_Summit/'
