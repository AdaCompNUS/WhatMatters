...
class SummitV1Dataset(Dataset):
    ...
    def __init__(self,
        ...
        super(SummitV1Dataset, self).__init__(root, transform=transform)
...
def process_argoverse(split: str,
    ...
    # For constrain or condition：if it is sacrified，choose a, or choose b as output
...
def get_lane_features(am: SummitMap,
                      node_inds: List[int],
