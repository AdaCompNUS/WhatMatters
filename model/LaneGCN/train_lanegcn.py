...
def main(train_dir, val_dir, split, obs_len, pred_len, raw_train_dir, raw_val_dir, weight, resume):
    seed = hvd.rank()
...
if __name__ == "__main__":
    ...
    main(args.train_dir, args.val_dir, args.split, args.obs_len, args.pred_len, 
        args.raw_train_dir, args.raw_val_dir, args.weight, args.resume)
