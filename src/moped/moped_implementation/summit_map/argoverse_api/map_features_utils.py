...
from map_utils.map_api import ArgoverseMap
from summit_map.summit_api.map_utils.summit_map_api import SummitMap

from map_utils.centerline_utils import (
    get_nt_distance,
    remove_overlapping_lane_seq,
)

from map_utils.mpl_plotting_utils import visualize_centerline
...
class MapFeaturesUtils:
    ...
    def get_point_in_polygon_score(self, lane_seq: List[int],
                                   ...
                                   avm: Union[ArgoverseMap, SummitMap]) -> int:
        ...
        Args:
            ...
            avm: Argoverse map_utils instance
        Returns:
    ...
    def sort_lanes_based_on_point_in_polygon_score(
            ...
            xy_seq: np.ndarray,
            city_name: str,
            avm: Union[ArgoverseMap, SummitMap],
    ) -> List[List[int]]:
    ...
    def compute_map_features(
        ...
        if city_name == "MIA" or city_name == "PIT":
            avm = ArgoverseMap()
        else:
            avm = SummitMap()
