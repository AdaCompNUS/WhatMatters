...
parser.add_argument("--obs_len", default="", type=str)
parser.add_argument("--pred_len", default="", type=str)
parser.add_argument("--raw_train_dir", default="", type=str)
parser.add_argument("--raw_val_dir", default="", type=str)
parser.add_argument("--raw_test_dir", default="", type=str)
parser.add_argument("--weight", default="", type=str)
parser.add_argument("--resume", default="", type=str)
parser.add_argument("--H", default="localhost:4", type=str)

def main(train_dir, val_dir, test_dir, split, obs_len, pred_len, raw_train_dir, raw_val_dir, raw_test_dir, weight, resume):
    seed = hvd.rank()
...
if __name__ == "__main__":
    ...
    main(args.train_dir, args.val_dir, args.test_dir, args.split, args.obs_len, args.pred_len, 
        args.raw_train_dir, args.raw_val_dir, args.raw_test_dir, args.weight, args.resume)
