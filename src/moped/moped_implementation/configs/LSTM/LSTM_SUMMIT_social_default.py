...
model = dict(
    ...
    train_cfg = dict(
        ...
        val_path = 'model/LSTM/saved_models_summit/lstm_social/LSTM_rollout30.pth.tar',
    ),
    test_cfg = dict(
        test_batch_size = 512,
        joblib_batch_size = 100,
        model_path = 'model/LSTM/saved_models_summit/lstm_social/LSTM_rollout30.pth.tar',
        traj_save_path = '../saved_trajectories_summit/lstm_social/rollout30_traj_test.pkl',
    ),
    val_cfg=dict(
        test_batch_size = 512,
        joblib_batch_size = 100,
        model_path = 'simulator/LSTM/lstm_social/LSTM_rollout30.pth.tar',
