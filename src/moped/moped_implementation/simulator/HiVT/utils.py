...
def from_numpy(data):
    ...
    """
    for key in ['x','positions','edge_index','y','num_nodes','padding_mask','bos_mask','rotate_angles','lane_vectors',
            'is_intersections','turn_directions','traffic_controls','lane_actor_index','lane_actor_vectors','seq_id',
            'av_index','agent_index','city','origin','theta']:
