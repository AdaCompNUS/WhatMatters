...
from simulator.LaneGCN.utils import gpu, to_long,  Optimizer, StepLR, collate_fn

from simulator.LaneGCN.layers import Conv1d, Res1d, Linear, LinearRes, Null
...
config = dict()
"""Train"""
config["display_iters"] = 14329
config["val_iters"] = 14329 * 2
...
if "save_dir" not in config:
    config["save_dir"] = os.path.join(
        root_path, "../../../results", "lanegcn_summit"
    )
...
class PostProcess(nn.Module):
    ...
    def display(self, metrics, dt, epoch, lr=None):
        ...
        ade1, fde1, ade, fde, min_idcs, mr, mr6 = pred_metrics(preds, gt_preds, has_preds)

        print(
            "loss %2.4f %2.4f %2.4f, ade1 %2.4f, fde1 %2.4f, ade6 %2.4f, fde6 %2.4f, miss_rate %2.4f, miss_rate6 %2.4f"
            % (loss, cls, reg, ade1, fde1, ade, fde, mr, mr6)
        )
        print()
...
def pred_metrics(preds, gt_preds, has_preds):
    ...
    fde = err[:, -1].mean()
    mr6 = (err[:, -1]>2).mean()
    return ade1, fde1, ade, fde, min_idcs, mr, mr6
