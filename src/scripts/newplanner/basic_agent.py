...
#from global_route_planner import GlobalRoutePlanner No need global planner as path is already generated by waypoints in ego_vehicle
from misc import (get_speed, is_within_distance,
                                         get_trafficlight_trigger_location,
                                         compute_distance)


class BasicAgent(Summit):
    """
    ...
    def _vehicle_obstacle_detected(self, vehicle_list=None, max_distance=None, up_angle_th=90, low_angle_th=0, lane_offset=0):
        ...
        ego_location_position2d = carla.Vector2D(ego_location.x, ego_location.y)
        ego_wpt = self._map.get_nearest_route_point(ego_location_position2d)

        # Get the right offset
        if ego_wpt.lane < 0 and lane_offset != 0:
            lane_offset *= -1
